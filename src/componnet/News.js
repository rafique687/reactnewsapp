...
export default class News extends Component {
  ...
  articles = [
    ...
    {
      let url='https://newsapi.org/v2/top-headlines?country=us&apiKey=2ef132a3d275424fb9e6c84bc03e6300';
      let data = await fetch(url);
      let parsData= await data.json();
      //console.log(parsData.articles);
      this.setState({articles : this.parsData.articles});
      ...
      <div className='container my-3'>
        <div className='row'>
            {this.state.articles.map((element)=>{
               return  <div className="col-sm-4 mt-3"><Mynews title={element.title} url={element.url} urlToImage={element.urlToImage} description={element.description}/> </div>
            })}
